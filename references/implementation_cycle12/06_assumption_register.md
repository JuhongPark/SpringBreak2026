...
| 7 | Priority levels are sufficient for initial responder routing | ambiguous urgency | responder feedback next cycle | Engineering |
| 8 | Compact triage payload improves response speed | no practical gain | future operational metric | Engineering |
