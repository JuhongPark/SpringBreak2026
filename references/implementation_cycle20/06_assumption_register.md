...
| 2 | Rounding counts to nearest integer is acceptable for this planning scope | reviewer disagreement on rounding direction | product feedback review | Engineering |
