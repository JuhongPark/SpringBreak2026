...
|---|---|---|---|---|
| 1 | Stage-level counts improve root-cause speed | no triage improvement | operator feedback next cycle | Engineering |
...
| 8 | Breakdown payload size remains manageable | oversized response | future load test | Engineering |
